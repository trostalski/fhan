...
class DoseAndRate(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  type: 'CodeableConcept' = None,  doseRange: 'Range' = None,  doseQuantity: 'Quantity' = None,  rateRatio: 'Ratio' = None,  rateRange: 'Range' = None,  rateQuantity: 'Quantity' = None, ):
        self.id: str = id 
...
class Dosage(BaseModel):
    ...
    """
    def __init__(self, resourceType: str = "Dosage",  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  sequence: int = None,  text: str = None,  additionalInstruction: 'CodeableConcept' = None,  patientInstruction: str = None,  timing: 'Timing' = None,  asNeededBoolean: bool = None,  asNeededCodeableConcept: 'CodeableConcept' = None,  site: 'CodeableConcept' = None,  route: 'CodeableConcept' = None,  method: 'CodeableConcept' = None,  doseAndRate: 'DoseAndRate' = None,  maxDosePerPeriod: 'Ratio' = None,  maxDosePerAdministration: 'Quantity' = None,  maxDosePerLifetime: 'Quantity' = None, ):
