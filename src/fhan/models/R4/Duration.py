...
class Duration(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  value:  'float'  = None,  comparator:  'str'  = None,  unit:  'str'  = None,  system:  'str'  = None,  code:  'str'  = None, ):
        self.resourceType = resourceType or "Duration"
        self.id = id 
