...
class ProductShelfLife(BaseModel):
    ...
    """
    def __init__(self, resourceType: str = "ProductShelfLife",  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  type: 'CodeableConcept' = None,  period: 'Quantity' = None,  specialPrecautionsForStorage: 'CodeableConcept' = None, ):
