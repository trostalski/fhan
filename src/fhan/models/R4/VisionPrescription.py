...
class Prism(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  amount: float = None,  base: str = None, ):
        self.id: str = id 
...
class LensSpecification(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  product: 'CodeableConcept' = None,  eye: str = None,  sphere: float = None,  cylinder: float = None,  axis: int = None,  prism: 'Prism' = None,  add: float = None,  power: float = None,  backCurve: float = None,  diameter: float = None,  duration: 'Quantity' = None,  color: str = None,  brand: str = None,  note: 'Annotation' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
