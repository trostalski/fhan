...
class Qualification(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  code: 'CodeableConcept' = None,  period: 'Period' = None,  issuer: 'Reference' = None, ):
        self.id: str = id 
...
class Practitioner(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Practitioner",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  active: bool = None,  name: 'HumanName' = None,  telecom: 'ContactPoint' = None,  address: 'Address' = None,  gender: str = None,  birthDate: str = None,  photo: 'Attachment' = None,  qualification: 'Qualification' = None,  communication: 'CodeableConcept' = None, ):
