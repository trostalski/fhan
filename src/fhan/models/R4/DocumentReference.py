...
class RelatesTo(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: str = None,  target: 'Reference' = None, ):
        self.id: str = id 
...
class Content(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  attachment: 'Attachment' = None,  format: 'Coding' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Context(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  encounter: 'Reference' = None,  event: 'CodeableConcept' = None,  period: 'Period' = None,  facilityType: 'CodeableConcept' = None,  practiceSetting: 'CodeableConcept' = None,  sourcePatientInfo: 'Reference' = None,  related: 'Reference' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class DocumentReference(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "DocumentReference",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  masterIdentifier: 'Identifier' = None,  identifier: 'Identifier' = None,  status: str = None,  docStatus: str = None,  type: 'CodeableConcept' = None,  category: 'CodeableConcept' = None,  subject: 'Reference' = None,  date: str = None,  author: 'Reference' = None,  authenticator: 'Reference' = None,  custodian: 'Reference' = None,  relatesTo: 'RelatesTo' = None,  description: str = None,  securityLabel: 'CodeableConcept' = None,  content: 'Content' = None,  context: 'Context' = None, ):
