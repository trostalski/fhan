...
class Identifier(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  use:  'str'  = None,  type:  'CodeableConcept'  = None,  system:  'str'  = None,  value:  'str'  = None,  period:  'Period'  = None,  assigner:  'Reference'  = None, ):
