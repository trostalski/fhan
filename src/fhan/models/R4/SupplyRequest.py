...
class SupplyRequest(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "SupplyRequest",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  category: 'CodeableConcept' = None,  priority: str = None,  itemCodeableConcept: 'CodeableConcept' = None,  itemReference: 'Reference' = None,  quantity: 'Quantity' = None,  parameter: 'Parameter' = None,  occurrenceDateTime: str = None,  occurrencePeriod: 'Period' = None,  occurrenceTiming: 'Timing' = None,  authoredOn: str = None,  requester: 'Reference' = None,  supplier: 'Reference' = None,  reasonCode: 'CodeableConcept' = None,  reasonReference: 'Reference' = None,  deliverFrom: 'Reference' = None,  deliverTo: 'Reference' = None, ):
