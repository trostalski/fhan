...
class ElementDefinition:
    ...
    :param Extension extension:Question: Prompt for element phrased as question
    :param Extension extension:AllowedUnits: Units to use for measured value
    ...
    :param CodeableReference defaultValuebase64Binary: Specified value if missing from instance
    ...
    :param RatioRange defaultValuebase64Binary: Specified value if missing from instance
    ...
    :param Availability defaultValuebase64Binary: Specified value if missing from instance
    :param ExtendedContactDetail defaultValuebase64Binary: Specified value if missing from instance
    ...
    :param CodeableReference fixedbase64Binary: Value must be exactly this
    ...
    :param RatioRange fixedbase64Binary: Value must be exactly this
    ...
    :param Availability fixedbase64Binary: Value must be exactly this
    :param ExtendedContactDetail fixedbase64Binary: Value must be exactly this
    ...
    :param CodeableReference patternbase64Binary: Value must have at least these property values
    ...
    :param RatioRange patternbase64Binary: Value must have at least these property values
    ...
    :param Availability patternbase64Binary: Value must have at least these property values
    :param ExtendedContactDetail patternbase64Binary: Value must have at least these property values
    ...
    :param CodeableReference valuebase64Binary: Value of Example (one of allowed types)
    ...
    :param RatioRange valuebase64Binary: Value of Example (one of allowed types)
    ...
    :param Availability valuebase64Binary: Value of Example (one of allowed types)
    :param ExtendedContactDetail valuebase64Binary: Value of Example (one of allowed types)
    ...
    :param Element additional: Additional Bindings - more rules about the binding
    :param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    ...
    extension:Question: "Extension" = None
    
    extension:AllowedUnits: "Extension" = None
    ...
    defaultValuebase64Binary: "CodeableReference" = None
    ...
    defaultValuebase64Binary: "RatioRange" = None
    ...
    defaultValuebase64Binary: "Availability" = None
    
    defaultValuebase64Binary: "ExtendedContactDetail" = None
    ...
    fixedbase64Binary: "CodeableReference" = None
    ...
    fixedbase64Binary: "RatioRange" = None
    ...
    fixedbase64Binary: "Availability" = None
    
    fixedbase64Binary: "ExtendedContactDetail" = None
    ...
    patternbase64Binary: "CodeableReference" = None
    ...
    patternbase64Binary: "RatioRange" = None
    ...
    patternbase64Binary: "Availability" = None
    
    patternbase64Binary: "ExtendedContactDetail" = None
