...
class Component(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  definition: str = None,  expression: str = None, ):
        self.id: str = id 
...
class SearchParameter(DomainResource):
    ...
    def __init__(self, resourceType: str = "SearchParameter",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  url: str = None,  version: str = None,  name: str = None,  derivedFrom: str = None,  status: str = None,  experimental: bool = None,  date: str = None,  publisher: str = None,  contact: 'ContactDetail' = None,  description: str = None,  useContext: 'UsageContext' = None,  jurisdiction: 'CodeableConcept' = None,  purpose: str = None,  code: str = None,  base: str = None,  type: str = None,  expression: str = None,  xpath: str = None,  xpathUsage: str = None,  target: str = None,  multipleOr: bool = None,  multipleAnd: bool = None,  comparator: str = None,  modifier: str = None,  chain: str = None,  component: 'Component' = None, ):
        ...
        self.code: str = code 
        self.base: list[str] = base or []
        self.type: str = type 
        self.expression: str = expression 
        self.xpath: str = xpath 
        self.xpathUsage: str = xpathUsage 
        self.target: list[str] = target or []
        self.multipleOr: bool = multipleOr 
        self.multipleAnd: bool = multipleAnd 
        self.comparator: list[str] = comparator or []
        self.modifier: list[str] = modifier or []
