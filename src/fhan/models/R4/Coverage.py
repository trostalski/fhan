...
class _class(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  type: 'CodeableConcept' = None,  value: str = None,  name: str = None, ):
        self.id: str = id 
...
class Exception(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  type: 'CodeableConcept' = None,  period: 'Period' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.type: 'CodeableConcept' = type 
...
class CostToBeneficiary(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  type: 'CodeableConcept' = None,  valueQuantity: 'Quantity' = None,  valueMoney: 'Money' = None,  exception: 'Exception' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.type: 'CodeableConcept' = type 
...
class Coverage(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Coverage",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  type: 'CodeableConcept' = None,  policyHolder: 'Reference' = None,  subscriber: 'Reference' = None,  subscriberId: str = None,  beneficiary: 'Reference' = None,  dependent: str = None,  relationship: 'CodeableConcept' = None,  period: 'Period' = None,  payor: 'Reference' = None,  _class: '_class' = None,  order: int = None,  network: str = None,  costToBeneficiary: 'CostToBeneficiary' = None,  subrogation: bool = None,  contract: 'Reference' = None, ):
