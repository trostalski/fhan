...
class QuantitativeDetails(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  customaryUnit: 'CodeableConcept' = None,  unit: 'CodeableConcept' = None,  conversionFactor: float = None,  decimalPrecision: int = None, ):
        self.id: str = id 
...
class QualifiedInterval(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  category: str = None,  range: 'Range' = None,  context: 'CodeableConcept' = None,  appliesTo: 'CodeableConcept' = None,  gender: str = None,  age: 'Range' = None,  gestationalAge: 'Range' = None,  condition: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class ObservationDefinition(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "ObservationDefinition",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  category: 'CodeableConcept' = None,  code: 'CodeableConcept' = None,  identifier: 'Identifier' = None,  permittedDataType: str = None,  multipleResultsAllowed: bool = None,  method: 'CodeableConcept' = None,  preferredReportName: str = None,  quantitativeDetails: 'QuantitativeDetails' = None,  qualifiedInterval: 'QualifiedInterval' = None,  validCodedValueSet: 'Reference' = None,  normalCodedValueSet: 'Reference' = None,  abnormalCodedValueSet: 'Reference' = None,  criticalCodedValueSet: 'Reference' = None, ):
        ...
        self.permittedDataType: list[str] = permittedDataType or []
