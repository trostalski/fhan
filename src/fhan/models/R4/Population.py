...
class Population(ModelBase):
    ...
    """
    def __init__(self, resourceType: str = "Population",  id: str = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  ageRange: 'Range' = None,  gender: 'CodeableConcept' = None,  race: 'CodeableConcept' = None,  physiologicalCondition: 'CodeableConcept' = None, ):
