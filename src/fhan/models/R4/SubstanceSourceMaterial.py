...
class FractionDescription(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  fraction: str = None,  materialType: 'CodeableConcept' = None, ):
        self.id: str = id 
...
class Author(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  authorType: 'CodeableConcept' = None,  authorDescription: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Hybrid(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  maternalOrganismId: str = None,  maternalOrganismName: str = None,  paternalOrganismId: str = None,  paternalOrganismName: str = None,  hybridType: 'CodeableConcept' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class OrganismGeneral(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  kingdom: 'CodeableConcept' = None,  phylum: 'CodeableConcept' = None,  _class: 'CodeableConcept' = None,  order: 'CodeableConcept' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Organism(BaseModel):
    ...
    """
    def __init__(self,  organismId: 'Identifier' = None,  organismName: str = None,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  family: 'CodeableConcept' = None,  genus: 'CodeableConcept' = None,  species: 'CodeableConcept' = None,  intraspecificType: 'CodeableConcept' = None,  intraspecificDescription: str = None,  author: 'Author' = None,  hybrid: 'Hybrid' = None,  organismGeneral: 'OrganismGeneral' = None, ):
...
class PartDescription(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  part: 'CodeableConcept' = None,  partLocation: 'CodeableConcept' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class SubstanceSourceMaterial(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "SubstanceSourceMaterial",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  sourceMaterialClass: 'CodeableConcept' = None,  sourceMaterialType: 'CodeableConcept' = None,  sourceMaterialState: 'CodeableConcept' = None,  organismId: 'Identifier' = None,  organismName: str = None,  parentSubstanceId: 'Identifier' = None,  parentSubstanceName: str = None,  countryOfOrigin: 'CodeableConcept' = None,  geographicalLocation: str = None,  developmentStage: 'CodeableConcept' = None,  fractionDescription: 'FractionDescription' = None,  organism: 'Organism' = None,  partDescription: 'PartDescription' = None, ):
        ...
        self.parentSubstanceName: list[str] = parentSubstanceName or []
        self.countryOfOrigin: list['CodeableConcept'] = countryOfOrigin or []
        self.geographicalLocation: list[str] = geographicalLocation or []
