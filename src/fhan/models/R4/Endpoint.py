...
class Endpoint(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Endpoint",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  connectionType: 'Coding' = None,  name: str = None,  managingOrganization: 'Reference' = None,  contact: 'ContactPoint' = None,  period: 'Period' = None,  payloadType: 'CodeableConcept' = None,  payloadMimeType: str = None,  address: str = None,  header: str = None, ):
        ...
        self.payloadMimeType: list[str] = payloadMimeType or []
