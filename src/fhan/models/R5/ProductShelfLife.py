...
class ProductShelfLife(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  type:  'CodeableConcept'  = None,  periodDuration:  'Duration'  = None,  periodString:  'str'  = None,  specialPrecautionsForStorage:  list['CodeableConcept']  = None, ):
