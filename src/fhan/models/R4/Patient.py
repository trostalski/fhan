...
class Contact(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  relationship: 'CodeableConcept' = None,  name: 'HumanName' = None,  telecom: 'ContactPoint' = None,  address: 'Address' = None,  gender: str = None,  organization: 'Reference' = None,  period: 'Period' = None, ):
        self.id: str = id 
...
class Link(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  other: 'Reference' = None,  type: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Patient(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Patient",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  active: bool = None,  name: 'HumanName' = None,  telecom: 'ContactPoint' = None,  gender: str = None,  birthDate: str = None,  deceasedBoolean: bool = None,  deceasedDateTime: str = None,  address: 'Address' = None,  maritalStatus: 'CodeableConcept' = None,  multipleBirthBoolean: bool = None,  multipleBirthInteger: int = None,  photo: 'Attachment' = None,  contact: 'Contact' = None,  communication: 'Communication' = None,  generalPractitioner: 'Reference' = None,  managingOrganization: 'Reference' = None,  link: 'Link' = None, ):
