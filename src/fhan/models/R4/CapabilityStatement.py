...
class Implementation(ModelBase):
    ...
    """
    def __init__(self,  id: str = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  description: str = None,  url: str = None,  custodian: 'Reference' = None,  implementationGuide: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Resource(ModelBase):
    ...
    """
    def __init__(self,  id: str = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  type: str = None,  profile: str = None,  supportedProfile: str = None,  documentation: str = None,  interaction: list['Interaction'] = None,  versioning: str = None,  readHistory: bool = None,  updateCreate: bool = None,  conditionalCreate: bool = None,  conditionalRead: str = None,  conditionalUpdate: bool = None,  conditionalDelete: str = None,  referencePolicy: str = None,  searchInclude: str = None,  searchRevInclude: str = None,  searchParam: list['SearchParam'] = None,  operation: list['Operation'] = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.type: str = type 
...
class Rest(ModelBase):
    ...
    """
    def __init__(self,  id: str = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  mode: str = None,  documentation: str = None,  security: 'Security' = None,  resource: list['Resource'] = None,  interaction: list['Interaction'] = None,  compartment: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.mode: str = mode 
...
class CapabilityStatement(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "CapabilityStatement",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: list['Resource'] = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  url: str = None,  version: str = None,  name: str = None,  title: str = None,  status: str = None,  experimental: bool = None,  date: str = None,  publisher: str = None,  contact: list['ContactDetail'] = None,  description: str = None,  useContext: list['UsageContext'] = None,  jurisdiction: list['CodeableConcept'] = None,  purpose: str = None,  copyright: str = None,  kind: str = None,  instantiates: str = None,  imports: str = None,  software: 'Software' = None,  implementation: 'Implementation' = None,  fhirVersion: str = None,  format: str = None,  patchFormat: str = None,  rest: list['Rest'] = None,  messaging: list['Messaging'] = None,  document: list['Document'] = None, ):
