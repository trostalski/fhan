...
class Detail(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  kind: str = None,  instantiatesCanonical: str = None,  instantiatesUri: str = None,  code: 'CodeableConcept' = None,  reasonCode: 'CodeableConcept' = None,  reasonReference: 'Reference' = None,  goal: 'Reference' = None,  status: str = None,  statusReason: 'CodeableConcept' = None,  doNotPerform: bool = None,  scheduledTiming: 'Timing' = None,  scheduledPeriod: 'Period' = None,  scheduledString: str = None,  location: 'Reference' = None,  performer: 'Reference' = None,  productCodeableConcept: 'CodeableConcept' = None,  productReference: 'Reference' = None,  dailyAmount: 'Quantity' = None,  quantity: 'Quantity' = None,  description: str = None, ):
        self.id: str = id 
...
class Activity(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  outcomeCodeableConcept: 'CodeableConcept' = None,  outcomeReference: 'Reference' = None,  progress: 'Annotation' = None,  reference: 'Reference' = None,  detail: 'Detail' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class CarePlan(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "CarePlan",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  instantiatesCanonical: str = None,  instantiatesUri: str = None,  basedOn: 'Reference' = None,  replaces: 'Reference' = None,  partOf: 'Reference' = None,  status: str = None,  intent: str = None,  category: 'CodeableConcept' = None,  title: str = None,  description: str = None,  subject: 'Reference' = None,  encounter: 'Reference' = None,  period: 'Period' = None,  created: str = None,  author: 'Reference' = None,  contributor: 'Reference' = None,  careTeam: 'Reference' = None,  addresses: 'Reference' = None,  supportingInfo: 'Reference' = None,  goal: 'Reference' = None,  activity: 'Activity' = None,  note: 'Annotation' = None, ):
