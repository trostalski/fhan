...
class Coverage(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  coverage: 'Reference' = None,  priority: int = None, ):
        self.id: str = id 
...
class Guarantor(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  party: 'Reference' = None,  onHold: bool = None,  period: 'Period' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Account(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Account",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  type: 'CodeableConcept' = None,  name: str = None,  subject: 'Reference' = None,  servicePeriod: 'Period' = None,  coverage: 'Coverage' = None,  owner: 'Reference' = None,  description: str = None,  guarantor: 'Guarantor' = None,  partOf: 'Reference' = None, ):
