...
class EnrollmentRequest(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "EnrollmentRequest",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  created: str = None,  insurer: 'Reference' = None,  provider: 'Reference' = None,  candidate: 'Reference' = None,  coverage: 'Reference' = None, ):
