...
class CodeSystem:
    ...
    :param Extension extension:sourceReference: Where did this content come from
    :param Extension extension:otherName: Alternative names
    ...
    extension:sourceReference: "Extension" = None
    
    extension:otherName: "Extension" = None
