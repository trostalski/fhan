...
class moiety(Element):
    ...
    """
    moiety: list["BackboneElement"] = None
...
class structure(Element):
    ...
    isotope: list["BackboneElement"] = None
    ...
    representation: list["BackboneElement"] = None
...
class code(Element):
    ...
    :param Reference source: Supporting literature
    """
    code: list["BackboneElement"] = None
...
class name(Element):
    ...
    synonym: list["BackboneElement"] = None
    
    translation: list["BackboneElement"] = None
    
    official: list["BackboneElement"] = None
...
class relationship(Element):
    ...
    :param Reference source: Supporting literature
    """
    relationship: list["BackboneElement"] = None
