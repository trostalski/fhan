...
class NamePart(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  part: str = None,  type: 'Coding' = None, ):
        self.id: str = id 
...
class CountryLanguage(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  country: 'CodeableConcept' = None,  jurisdiction: 'CodeableConcept' = None,  language: 'CodeableConcept' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Name(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  productName: str = None,  namePart: 'NamePart' = None,  countryLanguage: 'CountryLanguage' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class ManufacturingBusinessOperation(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  operationType: 'CodeableConcept' = None,  authorisationReferenceNumber: 'Identifier' = None,  effectiveDate: str = None,  confidentialityIndicator: 'CodeableConcept' = None,  manufacturer: 'Reference' = None,  regulator: 'Reference' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class SpecialDesignation(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  type: 'CodeableConcept' = None,  intendedUse: 'CodeableConcept' = None,  indicationCodeableConcept: 'CodeableConcept' = None,  indicationReference: 'Reference' = None,  status: 'CodeableConcept' = None,  date: str = None,  species: 'CodeableConcept' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class MedicinalProduct(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "MedicinalProduct",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  type: 'CodeableConcept' = None,  domain: 'Coding' = None,  combinedPharmaceuticalDoseForm: 'CodeableConcept' = None,  legalStatusOfSupply: 'CodeableConcept' = None,  additionalMonitoringIndicator: 'CodeableConcept' = None,  specialMeasures: str = None,  paediatricUseIndicator: 'CodeableConcept' = None,  productClassification: 'CodeableConcept' = None,  marketingStatus: 'MarketingStatus' = None,  pharmaceuticalProduct: 'Reference' = None,  packagedMedicinalProduct: 'Reference' = None,  attachedDocument: 'Reference' = None,  masterFile: 'Reference' = None,  contact: 'Reference' = None,  clinicalTrial: 'Reference' = None,  name: 'Name' = None,  crossReference: 'Identifier' = None,  manufacturingBusinessOperation: 'ManufacturingBusinessOperation' = None,  specialDesignation: 'SpecialDesignation' = None, ):
        ...
        self.specialMeasures: list[str] = specialMeasures or []
