...
class DependsOn(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  property: str = None,  system: str = None,  value: str = None,  display: str = None, ):
        self.id: str = id 
...
class Target(BaseModel):
    ...
    :param 'Product' product: Other elements required for this mapping (from context)
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: str = None,  display: str = None,  equivalence: str = None,  comment: str = None,  dependsOn: 'DependsOn' = None,  product: 'Product' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.code: str = code 
...
class Element(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: str = None,  display: str = None,  target: 'Target' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.code: str = code 
...
class Unmapped(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  mode: str = None,  code: str = None,  display: str = None,  url: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.mode: str = mode 
...
class Group(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  source: str = None,  sourceVersion: str = None,  target: str = None,  targetVersion: str = None,  element: 'Element' = None,  unmapped: 'Unmapped' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
