...
class ProductShelfLife(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  identifier:  'Identifier'  = None,  type:  'CodeableConcept'  = None,  period:  'Quantity'  = None,  specialPrecautionsForStorage:  list['CodeableConcept']  = None, ):
