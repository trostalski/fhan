...
class ChargeItem(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "ChargeItem",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  definitionUri: str = None,  definitionCanonical: str = None,  status: str = None,  partOf: 'Reference' = None,  code: 'CodeableConcept' = None,  subject: 'Reference' = None,  context: 'Reference' = None,  occurrenceDateTime: str = None,  occurrencePeriod: 'Period' = None,  occurrenceTiming: 'Timing' = None,  performer: 'Performer' = None,  performingOrganization: 'Reference' = None,  requestingOrganization: 'Reference' = None,  costCenter: 'Reference' = None,  quantity: 'Quantity' = None,  bodysite: 'CodeableConcept' = None,  factorOverride: float = None,  priceOverride: 'Money' = None,  overrideReason: str = None,  enterer: 'Reference' = None,  enteredDate: str = None,  reason: 'CodeableConcept' = None,  service: 'Reference' = None,  productReference: 'Reference' = None,  productCodeableConcept: 'CodeableConcept' = None,  account: 'Reference' = None,  note: 'Annotation' = None,  supportingInformation: 'Reference' = None, ):
        ...
        self.definitionUri: list[str] = definitionUri or []
        self.definitionCanonical: list[str] = definitionCanonical or []
