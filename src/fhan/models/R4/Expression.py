...
class Expression(BaseModel):
    ...
    """
    def __init__(self, resourceType: str = "Expression",  id: str = None,  extension: 'Extension' = None,  description: str = None,  name: str = None,  language: str = None,  expression: str = None,  reference: str = None, ):
