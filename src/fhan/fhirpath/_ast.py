...
Modified from https://github.com/google/fhir-py/blob/main/google-fhir-core/google/fhir/core/fhir_path/_ast.py#L940
"""
...
from fhan.fhirpath.generated.FhirPathLexer import FhirPathLexer
from fhan.fhirpath.generated.FhirPathParser import FhirPathParser
from fhan.fhirpath.generated.FhirPathVisitor import FhirPathVisitor

Number = Union[int, decimal.Decimal]


_StrEnum = (enum.StrEnum,) if sys.version_info[:2] >= (3, 11) else (str, enum.Enum)
...
class AbstractSyntaxTree(abc.ABC):
    ...
    def __init__(self, children: Optional[List["AbstractSyntaxTree"]] = None) -> None:
...
class _FhirPathCstVisitor(FhirPathVisitor):
    ...
    def _build_boolean_logic(self, ctx: _LogicalExpressionContext) -> BooleanLogic:
    ...
    def visitBooleanLiteral(self, ctx: FhirPathParser.BooleanLiteralContext) -> bool:
    ...
    def visitNumberLiteral(self, ctx: FhirPathParser.NumberLiteralContext) -> Number:
    ...
    def visitDateTimeLiteral(self, ctx: FhirPathParser.DateTimeLiteralContext) -> str:
        raw_str: str = ctx.getChild(0).getText()
        return raw_str
    ...
    def visitParamList(self, ctx: FhirPathParser.ParamListContext) -> List[Expression]:
    ...
    def visitIdentifier(self, ctx: FhirPathParser.IdentifierContext) -> Identifier:
...
class FhirPathAstBaseVisitor(abc.ABC):
    ...
    def visit_children(self, node: AbstractSyntaxTree, **kwargs: Any) -> List[Any]:
    ...
    @abc.abstractmethod
    def visit_boolean_logic(self, boolean_logic: BooleanLogic, **kwargs: Any) -> Any:
        pass

    @abc.abstractmethod
    def visit_membership(self, membership: MembershipRelation, **kwargs: Any) -> Any:
        pass
...
def _paths_referenced_by(
    ...
    if isinstance(node, Invocation):
        ...
        child_paths = tuple(
            _append_path_to_context(context, child_path) for child_path in child_paths
        )
