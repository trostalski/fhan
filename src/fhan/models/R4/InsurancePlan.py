...
class Benefit(ModelBase):
    ...
    :param list['Limit'] limit: Benefit limits
    """
...
class Coverage(ModelBase):
    """ Details about the coverage offered by the insurance product.:param list['Reference'] coverageArea: Where product applies
    :param str id: Unique id for inter-element referencing
    :param list['Extension'] extension: Additional content defined by implementations
    :param list['Extension'] modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param 'CodeableConcept' type: Type of coverage
    :param list['Reference'] network: What networks provide coverage
    :param list['Benefit'] benefit: List of benefits
    """
...
class Cost(ModelBase):
    ...
    :param list['CodeableConcept'] qualifiers: Additional information about the cost
...
class Benefit(ModelBase):
    ...
    :param list['Cost'] cost: List of the costs
    """
...
class SpecificCost(ModelBase):
    ...
    :param list['Benefit'] benefit: Benefits list
    """
...
class Plan(ModelBase):
    ...
    :param list['Extension'] extension: Additional content defined by implementations
    :param list['Extension'] modifierExtension: Extensions that cannot be ignored even if unrecognized
    :param list['Identifier'] identifier: Business Identifier for Product
    :param 'CodeableConcept' type: Type of plan
    :param list['Reference'] coverageArea: Where product applies
    :param list['Reference'] network: What networks provide coverage
    :param list['GeneralCost'] generalCost: Overall costs
    :param list['SpecificCost'] specificCost: Specific costs
    """
...
class InsurancePlan(DomainResource):
    ...
    :param list['CodeableConcept'] type: Kind of product
    ...
    :param list['Reference'] coverageArea: Where product applies
    :param list['Contact'] contact: Contact for the product
    :param list['Reference'] endpoint: Technical endpoint
    :param list['Reference'] network: What networks are Included
    :param list['Coverage'] coverage: Coverage details
    :param list['Plan'] plan: Plan details
    """
    def __init__(self, resourceType: str = "InsurancePlan",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: list['Resource'] = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  identifier: list['Identifier'] = None,  status: str = None,  type: list['CodeableConcept'] = None,  name: str = None,  alias: str = None,  period: 'Period' = None,  ownedBy: 'Reference' = None,  administeredBy: 'Reference' = None,  coverageArea: list['Reference'] = None,  contact: list['Contact'] = None,  endpoint: list['Reference'] = None,  network: list['Reference'] = None,  coverage: list['Coverage'] = None,  plan: list['Plan'] = None, ):
