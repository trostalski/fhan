...
class ProdCharacteristic(BaseModel):
    ...
    """
    def __init__(self, resourceType: str = "ProdCharacteristic",  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  height: 'Quantity' = None,  width: 'Quantity' = None,  depth: 'Quantity' = None,  weight: 'Quantity' = None,  nominalVolume: 'Quantity' = None,  externalDiameter: 'Quantity' = None,  shape: str = None,  color: str = None,  imprint: str = None,  image: 'Attachment' = None,  scoring: 'CodeableConcept' = None, ):
        ...
        self.color: list[str] = color or []
        self.imprint: list[str] = imprint or []
