...
class characteristics(Element):
    ...
    """
    characteristics: list["BackboneElement"] = None
...
class routeOfAdministration(Element):
    ...
    """
    routeOfAdministration: list["BackboneElement"] = None
    ...
    targetSpecies: list["BackboneElement"] = None
    ...
    withdrawalPeriod: list["BackboneElement"] = None
