...
class MarketingStatus(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  modifierExtension:  list['Extension']  = None,  country:  'CodeableConcept'  = None,  jurisdiction:  'CodeableConcept'  = None,  status:  'CodeableConcept'  = None,  dateRange:  'Period'  = None,  restoreDate:  'str'  = None, ):
