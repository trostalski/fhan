...
class Batch(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  lotNumber: str = None,  expirationDate: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Medication(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Medication",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  code: 'CodeableConcept' = None,  status: str = None,  manufacturer: 'Reference' = None,  form: 'CodeableConcept' = None,  amount: 'Ratio' = None,  ingredient: 'Ingredient' = None,  batch: 'Batch' = None, ):
