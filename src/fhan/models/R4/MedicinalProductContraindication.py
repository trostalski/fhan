...
class MedicinalProductContraindication(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "MedicinalProductContraindication",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  subject: 'Reference' = None,  disease: 'CodeableConcept' = None,  diseaseStatus: 'CodeableConcept' = None,  comorbidity: 'CodeableConcept' = None,  therapeuticIndication: 'Reference' = None,  otherTherapy: 'OtherTherapy' = None,  population: 'Population' = None, ):
