...
class Address(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  use:  'str'  = None,  type:  'str'  = None,  text:  'str'  = None,  line:  list['str']  = None,  city:  'str'  = None,  district:  'str'  = None,  state:  'str'  = None,  postalCode:  'str'  = None,  country:  'str'  = None,  period:  'Period'  = None, ):
