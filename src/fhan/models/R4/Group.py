...
class Characteristic(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: 'CodeableConcept' = None,  valueCodeableConcept: 'CodeableConcept' = None,  valueBoolean: bool = None,  valueQuantity: 'Quantity' = None,  valueRange: 'Range' = None,  valueReference: 'Reference' = None,  exclude: bool = None,  period: 'Period' = None, ):
        self.id: str = id 
...
class Member(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  entity: 'Reference' = None,  period: 'Period' = None,  inactive: bool = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Group(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "Group",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  active: bool = None,  type: str = None,  actual: bool = None,  code: 'CodeableConcept' = None,  name: str = None,  quantity: int = None,  managingEntity: 'Reference' = None,  characteristic: 'Characteristic' = None,  member: 'Member' = None, ):
