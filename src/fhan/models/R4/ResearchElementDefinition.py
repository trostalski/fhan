...
class Characteristic(ModelBase):
    ...
    """
    def __init__(self,  id: str = None,  extension: list['Extension'] = None,  modifierExtension: list['Extension'] = None,  definitionCodeableConcept: 'CodeableConcept' = None,  usageContext: list['UsageContext'] = None,  exclude: bool = None,  unitOfMeasure: 'CodeableConcept' = None,  studyEffectiveDescription: str = None,  studyEffectiveDateTime: str = None,  studyEffectiveTimeFromStart: 'Duration' = None,  studyEffectiveGroupMeasure: str = None,  participantEffectiveDescription: str = None,  participantEffectiveDateTime: str = None,  participantEffectiveTimeFromStart: 'Duration' = None,  participantEffectiveGroupMeasure: str = None, ):
        self.id: str = id 
