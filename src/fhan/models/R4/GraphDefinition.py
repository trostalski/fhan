...
class Compartment(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  use: str = None,  code: str = None,  rule: str = None,  expression: str = None,  description: str = None, ):
        self.id: str = id 
    ...
    @classmethod
    def from_dict(cls, data: dict) -> "Compartment":
...
class Target(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  type: str = None,  params: str = None,  profile: str = None,  compartment: 'Compartment' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.type: str = type 
...
class Link(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  path: str = None,  sliceName: str = None,  min: int = None,  max: str = None,  description: str = None,  target: 'Target' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.path: str = path 
