...
class Target(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  measure: 'CodeableConcept' = None,  detailQuantity: 'Quantity' = None,  detailRange: 'Range' = None,  detailCodeableConcept: 'CodeableConcept' = None,  due: 'Duration' = None, ):
        self.id: str = id 
...
class Goal(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  category: 'CodeableConcept' = None,  description: 'CodeableConcept' = None,  priority: 'CodeableConcept' = None,  start: 'CodeableConcept' = None,  addresses: 'CodeableConcept' = None,  documentation: 'RelatedArtifact' = None,  target: 'Target' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Action(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  prefix: str = None,  title: str = None,  description: str = None,  textEquivalent: str = None,  priority: str = None,  code: 'CodeableConcept' = None,  reason: 'CodeableConcept' = None,  documentation: 'RelatedArtifact' = None,  goalId: str = None,  subjectCodeableConcept: 'CodeableConcept' = None,  subjectReference: 'Reference' = None,  trigger: 'TriggerDefinition' = None,  condition: 'Condition' = None,  input: 'DataRequirement' = None,  output: 'DataRequirement' = None,  relatedAction: 'RelatedAction' = None,  timingDateTime: str = None,  timingAge: 'Age' = None,  timingPeriod: 'Period' = None,  timingDuration: 'Duration' = None,  timingRange: 'Range' = None,  timingTiming: 'Timing' = None,  participant: 'Participant' = None,  type: 'CodeableConcept' = None,  groupingBehavior: str = None,  selectionBehavior: str = None,  requiredBehavior: str = None,  precheckBehavior: str = None,  cardinalityBehavior: str = None,  definitionCanonical: str = None,  definitionUri: str = None,  transform: str = None,  dynamicValue: 'DynamicValue' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        ...
        self.documentation: list['RelatedArtifact'] = documentation or []
        self.goalId: list[str] = goalId or []
