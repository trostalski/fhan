...
class Attachment(BaseModel):
    ...
    def __init__(self, resourceType: str = None,  id:  'str'  = None,  extension:  list['Extension']  = None,  contentType:  'str'  = None,  language:  'str'  = None,  data:  'str'  = None,  url:  'str'  = None,  size:  'int'  = None,  hash:  'str'  = None,  title:  'str'  = None,  creation:  'str'  = None, ):
