...
class ParameterDefinition(BaseModel):
    ...
    """
    def __init__(self, resourceType: str = "ParameterDefinition",  id: str = None,  extension: 'Extension' = None,  name: str = None,  use: str = None,  min: int = None,  max: str = None,  documentation: str = None,  type: str = None,  profile: str = None, ):
