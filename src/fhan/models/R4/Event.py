...
class Event(BaseModel):
    ...
    """
    def __init__(self, resourceType: str = "Event",  identifier: 'Identifier' = None,  instantiatesCanonical: str = None,  instantiatesUri: str = None,  basedOn: 'Reference' = None,  partOf: 'Reference' = None,  researchStudy: 'Reference' = None,  status: str = None,  statusReason: 'CodeableConcept' = None,  code: 'CodeableConcept' = None,  subject: 'Reference' = None,  encounter: 'Reference' = None,  occurrenceDateTime: str = None,  occurrencePeriod: 'Period' = None,  occurrenceTiming: 'Timing' = None,  recorded: str = None,  reportedBoolean: bool = None,  reportedReference: 'Reference' = None,  performer: 'Performer' = None,  location: 'Reference' = None,  reasonCode: 'CodeableConcept' = None,  reasonReference: 'Reference' = None,  note: 'Annotation' = None, ):
