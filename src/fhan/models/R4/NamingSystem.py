...
class UniqueId(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  type: str = None,  value: str = None,  preferred: bool = None,  comment: str = None,  period: 'Period' = None, ):
        self.id: str = id 
...
class NamingSystem(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "NamingSystem",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  name: str = None,  status: str = None,  kind: str = None,  date: str = None,  publisher: str = None,  contact: 'ContactDetail' = None,  responsible: str = None,  type: 'CodeableConcept' = None,  description: str = None,  useContext: 'UsageContext' = None,  jurisdiction: 'CodeableConcept' = None,  usage: str = None,  uniqueId: 'UniqueId' = None, ):
