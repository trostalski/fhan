...
class Issue(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  severity: str = None,  code: str = None,  details: 'CodeableConcept' = None,  diagnostics: str = None,  location: str = None,  expression: str = None, ):
        self.id: str = id 
        ...
        self.expression: list[str] = expression or []
...
class OperationOutcome(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "OperationOutcome",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  issue: 'Issue' = None, ):
