...
class SupportingInfo(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  sequence: int = None,  information: 'Reference' = None,  appliesToAll: bool = None, ):
        self.id: str = id 
...
class Insurance(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  focal: bool = None,  coverage: 'Reference' = None,  businessArrangement: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Diagnosis(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  diagnosisCodeableConcept: 'CodeableConcept' = None,  diagnosisReference: 'Reference' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Item(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  supportingInfoSequence: int = None,  category: 'CodeableConcept' = None,  productOrService: 'CodeableConcept' = None,  modifier: 'CodeableConcept' = None,  provider: 'Reference' = None,  quantity: 'Quantity' = None,  unitPrice: 'Money' = None,  facility: 'Reference' = None,  diagnosis: 'Diagnosis' = None,  detail: 'Reference' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.supportingInfoSequence: list[int] = supportingInfoSequence or []
...
class CoverageEligibilityRequest(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "CoverageEligibilityRequest",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  priority: 'CodeableConcept' = None,  purpose: str = None,  patient: 'Reference' = None,  servicedDate: str = None,  servicedPeriod: 'Period' = None,  created: str = None,  enterer: 'Reference' = None,  provider: 'Reference' = None,  insurer: 'Reference' = None,  facility: 'Reference' = None,  supportingInfo: 'SupportingInfo' = None,  insurance: 'Insurance' = None,  item: 'Item' = None, ):
