...
class Prediction(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  outcome: 'CodeableConcept' = None,  probabilityDecimal: float = None,  probabilityRange: 'Range' = None,  qualitativeRisk: 'CodeableConcept' = None,  relativeRisk: float = None,  whenPeriod: 'Period' = None,  whenRange: 'Range' = None,  rationale: str = None, ):
        self.id: str = id 
...
class RiskAssessment(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "RiskAssessment",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  basedOn: 'Reference' = None,  parent: 'Reference' = None,  status: str = None,  method: 'CodeableConcept' = None,  code: 'CodeableConcept' = None,  subject: 'Reference' = None,  encounter: 'Reference' = None,  occurrenceDateTime: str = None,  occurrencePeriod: 'Period' = None,  condition: 'Reference' = None,  performer: 'Reference' = None,  reasonCode: 'CodeableConcept' = None,  reasonReference: 'Reference' = None,  basis: 'Reference' = None,  prediction: 'Prediction' = None,  mitigation: str = None,  note: 'Annotation' = None, ):
