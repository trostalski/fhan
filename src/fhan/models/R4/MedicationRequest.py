...
class InitialFill(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  quantity: 'Quantity' = None,  duration: 'Duration' = None, ):
        self.id: str = id 
...
class DispenseRequest(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  initialFill: 'InitialFill' = None,  dispenseInterval: 'Duration' = None,  validityPeriod: 'Period' = None,  numberOfRepeatsAllowed: int = None,  quantity: 'Quantity' = None,  expectedSupplyDuration: 'Duration' = None,  performer: 'Reference' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class Substitution(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  allowedBoolean: bool = None,  allowedCodeableConcept: 'CodeableConcept' = None,  reason: 'CodeableConcept' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class MedicationRequest(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "MedicationRequest",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  status: str = None,  statusReason: 'CodeableConcept' = None,  intent: str = None,  category: 'CodeableConcept' = None,  priority: str = None,  doNotPerform: bool = None,  reportedBoolean: bool = None,  reportedReference: 'Reference' = None,  medicationCodeableConcept: 'CodeableConcept' = None,  medicationReference: 'Reference' = None,  subject: 'Reference' = None,  encounter: 'Reference' = None,  supportingInformation: 'Reference' = None,  authoredOn: str = None,  requester: 'Reference' = None,  performer: 'Reference' = None,  performerType: 'CodeableConcept' = None,  recorder: 'Reference' = None,  reasonCode: 'CodeableConcept' = None,  reasonReference: 'Reference' = None,  instantiatesCanonical: str = None,  instantiatesUri: str = None,  basedOn: 'Reference' = None,  groupIdentifier: 'Identifier' = None,  courseOfTherapyType: 'CodeableConcept' = None,  insurance: 'Reference' = None,  note: 'Annotation' = None,  dosageInstruction: 'Dosage' = None,  dispenseRequest: 'DispenseRequest' = None,  substitution: 'Substitution' = None,  priorPrescription: 'Reference' = None,  detectedIssue: 'Reference' = None,  eventHistory: 'Reference' = None, ):
