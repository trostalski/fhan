...
class Applicability(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  description: str = None,  language: str = None,  expression: str = None, ):
        self.id: str = id 
...
class PropertyGroup(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  priceComponent: 'PriceComponent' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class ChargeItemDefinition(DomainResource):
    ...
    def __init__(self, resourceType: str = "ChargeItemDefinition",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  url: str = None,  identifier: 'Identifier' = None,  version: str = None,  title: str = None,  derivedFromUri: str = None,  partOf: str = None,  replaces: str = None,  status: str = None,  experimental: bool = None,  date: str = None,  publisher: str = None,  contact: 'ContactDetail' = None,  description: str = None,  useContext: 'UsageContext' = None,  jurisdiction: 'CodeableConcept' = None,  copyright: str = None,  approvalDate: str = None,  lastReviewDate: str = None,  effectivePeriod: 'Period' = None,  code: 'CodeableConcept' = None,  instance: 'Reference' = None,  applicability: 'Applicability' = None,  propertyGroup: 'PropertyGroup' = None, ):
        ...
        self.derivedFromUri: list[str] = derivedFromUri or []
        self.partOf: list[str] = partOf or []
