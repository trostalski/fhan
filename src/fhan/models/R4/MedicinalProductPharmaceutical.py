...
class Characteristics(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: 'CodeableConcept' = None,  status: 'CodeableConcept' = None, ):
        self.id: str = id 
...
class WithdrawalPeriod(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  tissue: 'CodeableConcept' = None,  value: 'Quantity' = None,  supportingInformation: str = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
...
class TargetSpecies(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: 'CodeableConcept' = None,  withdrawalPeriod: 'WithdrawalPeriod' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.code: 'CodeableConcept' = code 
...
class RouteOfAdministration(BaseModel):
    ...
    """
    def __init__(self,  id: str = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  code: 'CodeableConcept' = None,  firstDose: 'Quantity' = None,  maxSingleDose: 'Quantity' = None,  maxDosePerDay: 'Quantity' = None,  maxDosePerTreatmentPeriod: 'Ratio' = None,  maxTreatmentPeriod: 'Duration' = None,  targetSpecies: 'TargetSpecies' = None, ):
        self.id: str = id 
        self.extension: list['Extension'] = extension or []
        self.modifierExtension: list['Extension'] = modifierExtension or []
        self.code: 'CodeableConcept' = code 
...
class MedicinalProductPharmaceutical(DomainResource):
    ...
    """
    def __init__(self, resourceType: str = "MedicinalProductPharmaceutical",  id: str = None,  meta: 'Meta' = None,  implicitRules: str = None,  language: str = None,  text: 'Narrative' = None,  contained: 'Resource' = None,  extension: 'Extension' = None,  modifierExtension: 'Extension' = None,  identifier: 'Identifier' = None,  administrableDoseForm: 'CodeableConcept' = None,  unitOfPresentation: 'CodeableConcept' = None,  ingredient: 'Reference' = None,  device: 'Reference' = None,  characteristics: 'Characteristics' = None,  routeOfAdministration: 'RouteOfAdministration' = None, ):
