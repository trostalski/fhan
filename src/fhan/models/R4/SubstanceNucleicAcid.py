...
class subunit(Element):
    ...
    :param BackboneElement subunit: Subunits are listed in order of decreasing length; sequences of the same length will be ordered by molecular weight; subunits that have identical sequences will be repeated multiple times
    ...
    :param BackboneElement linkage: The linkages between sugar residues will also be captured
    :param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    ...
    :param BackboneElement sugar: 5.3.6.8.1 Sugar ID (Mandatory)
    :param str id: Unique id for inter-element referencing
    :param Extension extension: Additional content defined by implementations
    :param Extension modifierExtension: Extensions that cannot be ignored even if unrecognized
    ...
    """
    subunit: list["BackboneElement"] = None
    ...
    linkage: list["BackboneElement"] = None
    ...
    sugar: list["BackboneElement"] = None
